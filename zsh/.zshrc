...
# Plugins sugeridos para productividad
# 1. git: Atajos para comandos git
# 2. zsh-autosuggestions: El autocompletado gris (estilo Fish)
# 3. zsh-syntax-highlighting: Colores en los comandos
# 4. sudo: Presiona 'Esc' dos veces para añadir sudo al comando anterior
plugins=(
    git 
    zsh-autosuggestions 
...
# Autocompletado sensible a mayúsculas/minúsculas
